...
export const authService = {
  login: (credentials: { email: string; password: string }) =>
    apiClient.post<ApiResponse<{ user: User; token: string }>>(API_ENDPOINTS.AUTH.LOGIN, credentials),
  
  register: (userData: { name: string; email: string; password: string; role?: string }) =>
    apiClient.post<ApiResponse<{ user: User; token: string }>>(API_ENDPOINTS.AUTH.REGISTER, userData),
...
export const productService = {
  getProducts: (params?: { page?: number; limit?: number; search?: string; category?: string }) =>
    apiClient.get<PaginatedResponse<Product>>(API_ENDPOINTS.PRODUCTS, { params }),
  
  getProduct: (id: string) =>
    apiClient.get<ApiResponse<Product>>(`${API_ENDPOINTS.PRODUCTS}/${id}`),
  ...
  updateProduct: (id: string, productData: Partial<Product>) =>
    apiClient.put<ApiResponse<Product>>(`${API_ENDPOINTS.PRODUCTS}/${id}`, productData),
...
export const categoryService = {
  ...
  createCategory: (categoryData: Partial<Category>) =>
    apiClient.post<ApiResponse<Category>>(API_ENDPOINTS.CATEGORIES, categoryData),
  
  updateCategory: (id: string, categoryData: Partial<Category>) =>
    apiClient.put<ApiResponse<Category>>(`${API_ENDPOINTS.CATEGORIES}/${id}`, categoryData),
...
export const supplierService = {
  getSuppliers: (params?: { page?: number; limit?: number; search?: string }) =>
    apiClient.get<PaginatedResponse<Supplier>>(API_ENDPOINTS.SUPPLIERS, { params }),
  
  getSupplier: (id: string) =>
    apiClient.get<ApiResponse<Supplier>>(`${API_ENDPOINTS.SUPPLIERS}/${id}`),
  
  createSupplier: (supplierData: Partial<Supplier>) =>
    apiClient.post<ApiResponse<Supplier>>(API_ENDPOINTS.SUPPLIERS, supplierData),
  
  updateSupplier: (id: string, supplierData: Partial<Supplier>) =>
    apiClient.put<ApiResponse<Supplier>>(`${API_ENDPOINTS.SUPPLIERS}/${id}`, supplierData),
...
export const purchaseOrderService = {
  getPurchaseOrders: (params?: { page?: number; limit?: number; status?: string }) =>
    apiClient.get<PaginatedResponse<PurchaseOrder>>(API_ENDPOINTS.PURCHASE_ORDERS, { params }),
  
  getPurchaseOrder: (id: string) =>
    apiClient.get<ApiResponse<PurchaseOrder>>(`${API_ENDPOINTS.PURCHASE_ORDERS}/${id}`),
  
  createPurchaseOrder: (orderData: Partial<PurchaseOrder>) =>
    apiClient.post<ApiResponse<PurchaseOrder>>(API_ENDPOINTS.PURCHASE_ORDERS, orderData),
  
  updatePurchaseOrder: (id: string, orderData: Partial<PurchaseOrder>) =>
    apiClient.put<ApiResponse<PurchaseOrder>>(`${API_ENDPOINTS.PURCHASE_ORDERS}/${id}`, orderData),
  
  deletePurchaseOrder: (id: string) =>
    apiClient.delete<ApiResponse<null>>(`${API_ENDPOINTS.PURCHASE_ORDERS}/${id}`),
}

// Sales Order Services
export const salesOrderService = {
  getSalesOrders: (params?: { page?: number; limit?: number; status?: string }) =>
    apiClient.get<PaginatedResponse<SalesOrder>>(API_ENDPOINTS.SALES_ORDERS, { params }),
  
  getSalesOrder: (id: string) =>
    apiClient.get<ApiResponse<SalesOrder>>(`${API_ENDPOINTS.SALES_ORDERS}/${id}`),
  
  createSalesOrder: (orderData: Partial<SalesOrder>) =>
    apiClient.post<ApiResponse<SalesOrder>>(API_ENDPOINTS.SALES_ORDERS, orderData),
  
  updateSalesOrder: (id: string, orderData: Partial<SalesOrder>) =>
    apiClient.put<ApiResponse<SalesOrder>>(`${API_ENDPOINTS.SALES_ORDERS}/${id}`, orderData),
...
export const stockMovementService = {
  getStockMovements: (params?: { page?: number; limit?: number; productId?: string; type?: string }) =>
    apiClient.get<PaginatedResponse<StockMovement>>(API_ENDPOINTS.STOCK_MOVEMENTS, { params }),
  
  createStockMovement: (movementData: Partial<StockMovement>) =>
    apiClient.post<ApiResponse<StockMovement>>(API_ENDPOINTS.STOCK_MOVEMENTS, movementData),
}
...
export const dashboardService = {
  ...
  getReports: (type: string, params?: Record<string, any>) =>
    apiClient.get<ApiResponse<any>>(`${API_ENDPOINTS.REPORTS}/${type}`, { params }),
}